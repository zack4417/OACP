...
OptOptions::OptOptions() {
  ...
  fmin_return=NULL;
  stopTolerance= rai::getParameter<double>("opt/stopTolerance", 1.5e-1);
  stopFTolerance= rai::getParameter<double>("opt/stopFTolerance", 1.5e-1);
  stopGTolerance= rai::getParameter<double>("opt/stopGTolerance", -1.);
  stopEvals = rai::getParameter<uint> ("opt/stopEvals", 500);
  stopIters = rai::getParameter<uint> ("opt/stopIters", 300);
  ...
  constrainedMethod = (ConstrainedMethodType)rai::getParameter<int>("opt/constrainedMethod", squaredPenalty);
